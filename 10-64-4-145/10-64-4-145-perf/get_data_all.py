...
def main():
    ...
    for item_qd in qd:
        ...
        for item_bs in bs:
            file_name = item_bs + '-' + item_qd + '-' + "randread-1cpu-1cpu"
...
#
#        for item_bs in bs:
#            file_name = item_bs + '-' + item_qd + '-' + "randwrite-1cpu-1cpu"
#            with open(file_name, 'r') as f:
#                lines = f.readlines()
#                last_line = lines[-2]
#                result=last_line.split()
...
#
#        for item_bs in bs:
#            file_name = item_bs + '-' + item_qd + '-' + "read-1cpu-1cpu"
#            with open(file_name, 'r') as f:
#                lines = f.readlines()
#                last_line = lines[-2]
#                result=last_line.split()
...
#
#        for item_bs in bs:
#            file_name = item_bs + '-' + item_qd + '-' + "write-1cpu-1cpu"
#            with open(file_name, 'r') as f:
#                lines = f.readlines()
#                last_line = lines[-2]
#                result=last_line.split()
