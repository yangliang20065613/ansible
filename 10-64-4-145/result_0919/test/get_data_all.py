...
def main():
    ...
    for item_rw in rw:
        ...
        for item_qd in qd:
            ...
            for item_bs in bs:
                file_name = item_bs + '-' + item_qd + 'q-' + item_rw + "-1cpusvc-8cpuclt"
                with open(file_name, 'r') as f:
                    lines = f.readlines()
                    result_iops_line = lines[17]
        ...
        result_file_name_xlsx = '1cpusvc-8cpuclt-' + item_rw + '.xlsx' 
